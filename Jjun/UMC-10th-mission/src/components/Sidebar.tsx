...
export const Sidebar = ({isOpen, onClose}: SidebarProps) => {
    ...
    return (
        <div 
            className={`fixed inset-0 bg-black/50 backrop-blur-sm 
                ...
                <nav className="flex-1 overflow-y-auto p-4">
                    <ul className="space-y-2">
                        <li>
                            <a
                                href="#search"
                                className="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-grat-100 transition-colors">
                                    <span>◎</span>
